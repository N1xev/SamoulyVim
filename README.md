...
2. **Installation**:
   - On Linux/MacOS:
     ...
     ```sh
     bash <(curl -s https://raw.githubusercontent.com/N1xev/SamoulyVim/main/installer/install.sh)
     ```

   - On Windows (Powershell):
     ```ps1
     Invoke-WebRequest https://raw.githubusercontent.com/N1xev/SamoulyVim/main/installer/install.ps1 -UseBasicParsing | Invoke-Expression
     ```
...
- special thanks for [Alexis12119](https://github.com/Alexis12119) this is based on his old neovim dotfiles!
