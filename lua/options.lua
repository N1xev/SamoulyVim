...
local options = {
  ...
  scrolloff = 2, -- minimal number of columns to scroll horizontally.
  sidescrolloff = 2, -- minimal number of screen columns
  ...
  shell = vim.fn.executable "pwsh.exe" and "pwsh.exe" or "powershell.exe",
  shellcmdflag = "-NoLogo -NoProfile -ExecutionPolicy RemoteSigned -Command [Console]::InputEncoding=[Console]::OutputEncoding=[System.Text.Encoding]::UTF8;",
  shellredir = "-RedirectStandardOutput %s -NoNewWindow -Wait",  -- UNCOMMENTED
  shellpipe = "2>&1 | Out-File -Encoding UTF8 %s; exit $LastExitCode",  -- UNCOMMENTED
  shellquote = "",  -- UNCOMMENTED
  shellxquote = "",  -- UNCOMMENTED
  shellslash = true,
}
