...
vim.g.colors_name = "Desert Sunset"
...
local p = {
  ...
  purple = "#d48474", -- Keywords (terracotta)
  blue = "#f2a474", -- Functions (sunset orange)
  cyan = "#c49474", -- Properties (mesa red)
  teal = "#b87a5c", -- Special tokens (canyon)

  -- Secondary colors
  orange = "#f2c494", -- Strings (sand)
  peach = "#e8d4b4", -- Parameters (dune)
  yellow = "#d4b474", -- Types (gold)
  gold = "#d4a474", -- Special highlights (honey)

  -- Nature-inspired alternatives
  sage = "#94b48c", -- Success states (sage)
  mint = "#a4c49c", -- Additions (succulent)
  seafoam = "#8cb494", -- Confirmations (agave)

  -- Semantic colors
  error = "#d47474", -- Errors (red rock)
  warning = "#e8b474", -- Warnings (sunset yellow)
  info = "#74a4c4", -- Information (oasis blue)
  hint = "#9cb4a4", -- Hints (desert sage)

  -- Special highlights
  magenta = "#b48cb4", -- Special keywords (cactus flower)
  pink = "#d48cb4", -- Emphasis (desert bloom)
