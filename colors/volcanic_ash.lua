...
vim.g.colors_name = "Volcanic ash"
...
local p = {
  ...
  purple = "#d48474", -- Keywords (hot ember)
  blue = "#f29474", -- Functions (flame)
  cyan = "#c47a5c", -- Properties (copper)
  teal = "#b88c67", -- Special tokens (bronze)

  -- Secondary colors
  orange = "#f2a074", -- Strings (lava)
  peach = "#f2c694", -- Parameters (amber)
  yellow = "#d4b874", -- Types (gold)
  gold = "#c4a874", -- Special highlights (brass)

  -- Nature-inspired alternatives
  sage = "#c48474", -- Success states (rust)
  mint = "#d49484", -- Additions (terracotta)
  seafoam = "#c47464", -- Confirmations (clay)

  -- Semantic colors
  error = "#f27474", -- Errors (hot red)
  warning = "#f2c474", -- Warnings (molten gold)
  info = "#74a4c4", -- Information (cool blue contrast)
  hint = "#a4b4b4", -- Hints (ash gray)

  -- Special highlights
  magenta = "#d474a4", -- Special keywords (magma pink)
  pink = "#d48494", -- Emphasis (hot rose)
