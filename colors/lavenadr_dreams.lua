...
vim.g.colors_name = "Lavender dreams"
...
local p = {
  ...
  purple = "#a884d4", -- Keywords (lilac)
  blue = "#8494f2", -- Functions (periwinkle)
  cyan = "#b87ac4", -- Properties (orchid)
  teal = "#9484d4", -- Special tokens (wisteria)

  -- Secondary colors
  orange = "#f2b494", -- Strings (peach)
  peach = "#f2c4b4", -- Parameters (blush)
  yellow = "#e8d4b4", -- Types (cream)
  gold = "#e8b4c4", -- Special highlights (rose)

  -- Nature-inspired alternatives
  sage = "#94c4a4", -- Success states (sage)
  mint = "#a4d4c4", -- Additions (mint)
  seafoam = "#a4c4b4", -- Confirmations (tea green)

  -- Semantic colors
  error = "#f27a94", -- Errors (rose red)
  warning = "#f2c484", -- Warnings (golden)
  info = "#84b4f2", -- Information (sky)
  hint = "#a4c4d4", -- Hints (powder blue)

  -- Special highlights
  magenta = "#c484d4", -- Special keywords (violet)
  pink = "#f294c4", -- Emphasis (pink)
