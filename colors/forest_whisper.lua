...
vim.g.colors_name = "forest whisper"
...
local p = {
  ...
  purple = "#87c9a0", -- Keywords (sage green)
  blue = "#5db88c", -- Functions (emerald)
  cyan = "#67c6b4", -- Properties (jade)
  teal = "#a8b877", -- Special tokens (olive)

  -- Secondary colors
  orange = "#d4a574", -- Strings (amber)
  peach = "#d9c3a0", -- Parameters (sand)
  yellow = "#c4b87a", -- Types (gold)
  gold = "#d4c074", -- Special highlights (honey)

  -- Nature-inspired alternatives
  sage = "#8cc4a8", -- Success states (fern)
  mint = "#9ed4b8", -- Additions (moss)
  seafoam = "#7ab89c", -- Confirmations (pine)

  -- Semantic colors
  error = "#d47a7a", -- Errors (clay red)
  warning = "#d4b474", -- Warnings (autumn)
  info = "#74b4c4", -- Information (stream blue)
  hint = "#8ec4a8", -- Hints (seafoam)

  -- Special highlights
  magenta = "#b48cc4", -- Special keywords (wildflower)
  pink = "#c48ca4", -- Emphasis (wild rose)
