...
local p = {
  ...
  purple = "#67b8d4", -- Keywords (shallow water)
  blue = "#7daff9", -- Functions (azure)
  cyan = "#4da8b8", -- Properties (teal)
  teal = "#67c4cc", -- Special tokens (aqua)

  -- Secondary colors
  orange = "#f2a87a", -- Strings (coral)
  peach = "#e6d4c0", -- Parameters (pearl)
  yellow = "#74d4c4", -- Types (turquoise)
  gold = "#8ed4cc", -- Special highlights (seafoam)

  -- Nature-inspired alternatives
  sage = "#74b8c4", -- Success states (marine)
  mint = "#9ed4cc", -- Additions (mint)
  seafoam = "#7ac4cc", -- Confirmations (lagoon)

  -- Semantic colors
  error = "#d47a87", -- Errors (red coral)
  warning = "#d4b487", -- Warnings (sand)
  info = "#74b4d4", -- Information (clear water)
  hint = "#8ec4c4", -- Hints (sea glass)

  -- Special highlights
  magenta = "#a884d4", -- Special keywords (jellyfish)
  pink = "#d48cb4", -- Emphasis (sea anemone)
